...
# from staff import Student, PostgraduateStudent, Department
from course import Course, CourseProgress, Seminar, Math
...
#department = Department("department", [student1, student3], [], [course])
